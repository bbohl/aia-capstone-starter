...
```
ghcr.io/skillrepos/aia-capstone-starter-devcontainer:latest
```
...
docker build --platform linux/amd64 -f .devcontainer/Dockerfile -t ghcr.io/skillrepos/aia-capstone-starter-devcontainer:latest .

# 3. Push to GHCR
docker push ghcr.io/skillrepos/aia-capstone-starter-devcontainer:latest
```
...
Go to: `github.com/orgs/skillrepos/packages/container/aia-capstone-starter-devcontainer/settings`
