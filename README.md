...
**3. Make sure you have your Hugging Face token from Day 1.  We'll need it to deploy.**

Refer back to [Day 1 README.md](https://github.com/skillrepos/aia-day1/blob/main/README.md) if you need to generate a new one.
